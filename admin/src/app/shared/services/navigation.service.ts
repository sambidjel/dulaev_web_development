...
export class NavigationService {
  ...
  iconMenu: IMenuItem[] = [
    ...
    },
    {
      ...
      state: "profile",
      sub: [
        { name: "Профиль менеджера", state: "settings" },
        { name: "Профиль организации", state: "overview" }
      ]
    },
    {
      name: "Клиенты",
      ...
      state: "client",
      sub: [
        { name: "Пользователи", state: "users" },
        { name: "Доставщики", state: "deliveryman" },
        { name: "Организации", state: "company" }
      ]
    },
    {
      name: "Продажи",
